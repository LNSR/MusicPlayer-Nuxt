      ...
      <aside class="min-h-full w-64 bg-base-200 text-base-content">
        ...
        <ul class="menu p-4 space-y-2">
          ...
          <li v-if="user?.isAdmin">
            <NuxtLink 
              to="/admin"
              class="flex items-center gap-3 bg-red-500 text-white rounded-full px-4 py-2 font-semibold shadow hover:bg-red-600 transition-colors"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-5 w-5"
              ...
              >
                <path
                  ...
                  stroke-linejoin="round"
                  stroke-width="2"
                  d="M12 11c0-1.104.896-2 2-2s2 .896 2 2-.896 2-2 2-2-.896-2-2zm-6 8v-1a4 4 0 014-4h4a4 4 0 014 4v1M6 7V6a6 6 0 1112 0v1"
                />
              </svg>
              Admin Panel
            </NuxtLink>
